    ...
    <section class="property-section">
        <div class="container">
            <div class="col-12 property-grid-slider property-grid-2">
                ...
                <ListingGridView2GridViewNoSidebarListdata :data="alldata" :lview="lview" :classes="classes" />
            </div>
        </div>
    </section>
</template>
...
let alldata: Data_Type[] = listdata.value.LatestPropertyListingInEnterprise;
