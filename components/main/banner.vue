        ...
        <div class="col-lg-12 p-0">
          <div class="video-bg position-relative h-auto" id="block" style="width: 100%">
            ...
            <div class="home-main feature-section new-property video-bg">
              <div class="container">
                <div class="feature-content video-details text-start p-0 vertical-search mt-0 width-350">
                    ...
                    <div class="row gx-2 justify-content-center">
                      ...
                      <!-- <div class="form-group">
                        <div class="input-group">
                          ...
                          <input :type="type" id="pwd-input1" class="form-control" placeholder="Password"
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="tel" class="form-control" v-model="user.phone" placeholder="eg.1234567890"
                            maxlength="10" pattern="[0-9]{10}" required />
                        </div>
                      </div>
                      <button class="btn btn-gradient color-4 col-8 mt-3" id="create-account"
