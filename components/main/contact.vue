                        ...
                        <form class="row gx-3">
                            ...
                            <div class="form-group col-md-6">
                                <div class="input-group">
                                    ...
                                    <input v-model.trim="phonenumber" placeholder="phone number" class="form-control"
                                        name="mobnumber" id="tbNumbers" type="tel" maxlength="10" required>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="input-group">
                            ...
                            <div class="col-md-12 submit-btn">
                                <button class="btn btn-gradient color-2 btn-pill" type="submit"
                                    @click.prevent="sendEmail">Send Your Message</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <ul v-if="item.type == 'social-media'">
                            <div class="footer-social sub-footer-link social-card">
                                <nuxt-link target="_blank"
                                    to="https://www.facebook.com/profile.php?id=61552522883538"><i
                                        class="fab fa-facebook-f fa-lg"></i></nuxt-link>
                                <nuxt-link target="_blank" to="https://www.instagram.com/the4thwall.studio/"><i
                                        class="fab fa-instagram fa-lg"></i></nuxt-link>
                                <nuxt-link target="_blank"
                                    to="https://youtube.com/@the4thwall.designs?si=TxelPfI7Np-_uaPA"><i
                                        class="fab fa-youtube fa-lg"></i></nuxt-link>
                            ...
                            <img src="/image/svg/twitter-x.svg" alt="Twitter link. " height="19">
                                ...
                                <nuxt-link to="https://www.linkedin.com/company/the-4th-wall-studio/"><i
                                        class="fab fa-linkedin fa-lg"></i></nuxt-link>
                            </div>
                        </ul>
...
const sendEmail = async () => {
    ...
    await supabase.from('messages').insert(messageInfo)
