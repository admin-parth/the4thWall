                    ...
                    <div class="agent-image">
                        <div :style="'background-image:url('+agent.src+')'" class="background bg-size">
                            ...
                            <div class="overlay-content">
                                <ul>
                                    <li v-for="(icon , index) in agent.icon" :key="index"><nuxt-link :to="icon.to"><img :src="icon.img" alt=""></nuxt-link>
                                    </li>
                                </ul>
                                <span>Connect</span>
                            </div>
...
let ouragent:Agency_Agent[] = data.value.agencygrid;
