        ...
        <div class="property-2 row column-sm property-label property-grid" :class="lview">
            <div class="wow fadeInUp" v-for="(agent, index) in ouragent" :key="index" :class="classes">
                <div class="property-box">
                    ...
                    <div class="agent-content agent-grid-content">
...
import agencyagent from 'static/data/types/agencyagent'
...
const { data } = await useFetch(useurl + '/data/agency.json');
const ouragent: agencyagent[] = data.value.grid;
