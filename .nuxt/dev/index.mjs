globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Parth/projects/Frontend/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://C:/Parth/projects/Frontend/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Parth/projects/Frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Parth/projects/Frontend/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Parth/projects/Frontend/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/Parth/projects/Frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Parth/projects/Frontend/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Parth/projects/Frontend/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Parth/projects/Frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Parth/projects/Frontend/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Parth/projects/Frontend/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Parth/projects/Frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Parth/projects/Frontend/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Parth/projects/Frontend/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Parth/projects/Frontend/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Parth/projects/Frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Parth/projects/Frontend/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Parth/projects/Frontend/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/Parth/projects/Frontend/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Parth/projects/Frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Parth/projects/Frontend/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Parth/projects/Frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Parth\\projects\\Frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Parth\\projects\\Frontend\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Parth\\projects\\Frontend\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Parth\\projects\\Frontend\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Parth\\projects\\Frontend\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_JEQhY4 = () => Promise.resolve().then(function () { return header$1; });
const _lazy_fbIlOk = () => Promise.resolve().then(function () { return searchRight$1; });
const _lazy_o4biSV = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/header', handler: _lazy_JEQhY4, lazy: true, middleware: false, method: undefined },
  { route: '/api/search-right', handler: _lazy_fbIlOk, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_o4biSV, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_o4biSV, lazy: true, middleware: false, method: undefined }
];
...
const header = defineEventHandler(() => {
  return [
    navlink$1
  ];
});
...
const rightdropdown$1 = { rightdropdown };

const searchRight = defineEventHandler(() => {
  return [
    rightdropdown$1
  ];
});

const searchRight$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: searchRight
});
...
const getClientManifest = () => import('file://C:/Parth/projects/Frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Parth/projects/Frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
